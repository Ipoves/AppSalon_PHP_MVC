...
function seleccionarServicio(servicio) {
    ...
    if(servicios.some( agregado => agregado.id === id  )) {
        //Si ya está agregado lo eliminamos de la cesta
        cita.servicios = servicios.filter( agregado => agregado.id !== id );
        divServicio.classList.remove('seleccionado');
        
    } else {
        // Si no está agregado lo añadimos
...
async function reservarCita() {
    ...
    //console.log([...datos]); de esta forma con los tres puntos y corchetes convertimos en array y podemos verificar los datos del FormData
}
